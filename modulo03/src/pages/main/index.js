    ...
    return (
      <SafeAreaView style={styles.container}>
        ...
        <View style={styles.content}>
          ...
          <Text style={styles.description}>Comece adicionando alguns repositórios aos seus favoritos.</Text>
          ...
          <View style={styles.form}>
            ...
            />
            <TouchableOpacity style={styles.button} onPress={this.addRepository} activeOpacity={0.6}>
            ...
            {!!this.props.favorites.errorOnAdd && <Text style={styles.error}>{this.props.favorites.errorOnAdd}</Text>}
          </View>
        </View>
